...
class RepairOrder(StatusModel, BaseModel):
    STATUS = Choices(
        ("received", "Received"),
    ...
    status = StatusField(default=STATUS.received)
    ...
    appointment = models.ForeignKey(
        "appointments.Appointment", on_delete=models.SET_NULL, null=True, blank=True, related_name="repairs"
    )
